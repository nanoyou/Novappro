...
public class ModifyCourseApplServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException,
        ...
        try {
            ...
            val updateAppliedCoursesServiceResult = COURSE_APPL_DETAIL_SERVICE.updateAppliedCourses(flowNo,
                    updatedCourseCodes);
            request.setAttribute(SC.ReqParam.SELECTED_COURSE_APPL_FLOW_NO.name, flowNo);
            request.setAttribute(SC.ReqAttr.UPDATE_APPLIED_COURSES_SERVICE_RESULT.name,
                    updateAppliedCoursesServiceResult);
            // 刷新页面
